...
val HeritageRed = Color(0xFF8E2A2A)          // акцент, заголовки фактов
...
val FactsPanel = Color(0xFFF3E3DD)           // фон панели фактов
val OnFactsPanel = Color(0xFF2B211D)         // высококонтрастный текст фактов

val MutedGreen = Color(0xFF4C6B3F)           // маркеры-точки в фактах
val OnMutedGreen = Color(0xFFFFFFFF)

val PaperSurface = Color(0xFFFDF8F6)         // фон/surface — тёплый белый
val OnSurfaceInk = Color(0xFF1B1B1B)         // основной текст
val OnSurfaceMuted = Color(0xFF4A413C)       // вторичный текст
